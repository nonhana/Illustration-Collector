...
if (localStorage.getItem("illustratorlist")) {
  for (var i = 0; i < JSON.parse(localStorage.getItem("illustratorlist")).length; i++) {
...
for (var i = 0; i < localillustratorlist.length; i++) {
  ...
  str = "<hr>" + "<div id='illustratoritem'>" +
    ...
    "<div id = 'details'>" +
    "<div id='name'>" +
    "<font>" + localillustratorlist[i].illustrator_name + "</font>" +
    "</div>" +
    "<div id='signal'>" +
    "<font>" + localillustratorlist[i].illustrator_sign + "</font>" +
    "</div>" +
    "<div id='style'>" +
    "<font>" + "风格：" + "<span>" + localillustratorlist[i].illustrator_style + "</span>" + "</font>" +
    "</div>" +
    "<div id='SNS'>" +
    "<font>" + "其他网站资讯：" +
    "<a class='uploaduser' target='_blank' href=''>" + "</a>" +
    "</font>" +
    "</div>" +
    "</div >" +
    "</div >" +
...
for (var i = 3; i < headArr.length; i++) {
  headArr[i][0].src
    = localillustratorlist[i - 3].illustrator_head_photo;
}
